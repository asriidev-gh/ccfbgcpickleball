...
const playerSchema = new Schema(
  {
    ...
    dgroupAvailableDays: { type: [String], default: [] },
    dgroupAvailableTimeFrom: { type: String, trim: true, maxlength: 5, default: "" },
    dgroupAvailableTimeTo: { type: String, trim: true, maxlength: 5, default: "" },
